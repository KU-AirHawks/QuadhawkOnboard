...
def main():
    ...
    # We want to use parse_args when we want rx_rate and tx_rate from the terminal itself.
    # Instead, we want to read from a file (placeholder_waveform).
    # We will need to change main to account for pulling that info from file rather than polling.(?)
    args = parse_args()
    ...
    if args.tx_rate:
        ...
        # usrp.set_tx_rate(placeholder_waveform.tx_rate)
